...
//   const [error, setError] = useState(null); // Set the initial error state to null
...
//     setLoading(true); // Start the loading state before fetching
...
//           </div>
//         ) : error ? (
//           <p className="mt-5 error_color">Error: {error}</p> // Display the error message
//         ) : coupons ? (
//           <p className="mt-5">No data found: {error}</p> // Display the error message
//         ) : (
...
//         <AreYouSure onConfirm={handleConfirmDelete} couponId={couponToDelete} />
//       </>
//     </>
//   );
// };
